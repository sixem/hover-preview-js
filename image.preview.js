...
(function ($) {
  ...
  $.fn.imagePreview = function (options) {
    ...
    var getElementPositions = function getElementPositions(target) {
    ...
    var getTopAdjustments = function getTopAdjustments(max, top) {
    ...
    var previewAdjust = function previewAdjust() {
    ...
    var previewShow = function previewShow(enable) {
      if (enable === false) {
      ...
      if (data !== false && data !== undefined) {
        ...
        if (_typeof(attr) !== (typeof undefined === "undefined" ? "undefined" : _typeof(undefined)) && attr !== false) main.last.src = attr;
      }
    ...
    var getWindowDimensions = function getWindowDimensions() {
      ...
      main.windowWidthH = $(window).width() / 2;
    };
    ...
    var bindHandlers = function bindHandlers() {
      ...
      $.each(main.settings.elements, function (index, value) {
        $(document).off('mouseenter', value).on('mouseenter', value, function (e) {
        ...
        $(document).off('mouseleave', value).on('mouseleave', value, function (e) {
          if (main.loading !== null) {
            $(main).trigger('loadChange', false);
            main.loading = null;
          }
        ...
        if (!main.settings.staticPreview) {
          $(document).off('mousemove', value).on('mousemove', value, function (e) {
